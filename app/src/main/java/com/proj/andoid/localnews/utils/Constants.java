...
/**
 * created by Alex Ivanov on 10/15/15.
 */
public class Constants {

    public static final int LOCATION_LOAD = 1;
    ...
    public static final String TwitterApiAccessToken = "3964942821-Oej3MkhlyAVc4mIIxqFOal1DXgAEskfNKEXOcqq";
    public static final String TwitterApiAccessTokenSecret = "dFprQdkkCTVwqttnGje6nreffIz4Bedwnk1OLYRxwMBih";
